    ...
    <div class="container">
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/cassio.gif" alt="" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/tripodi.gif" alt="" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/beatriz.gif" alt="" width="300" height="300" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/renato.jpg" alt="" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/jussara.gif" alt="" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
          Aluno graduando do curso de Engenharia de Computação da Universidade Estadual de Feira de Santana (UEFS), Bahia, Brasil
        </div>
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/lucas.jpg" alt="" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/sillas.gif" alt="" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
          Aluno graduando do curso de Engenharia de Computação da Universidade Estadual de Feira de Santana (UEFS), Bahia, Brasil
        </div>
      ...
      <div class="row panel panel-default">
        ...
        <div class="col-md-4 col-sm-6">
          <img class="img-responsive center-block img-thumbnail" src="../img/membros/anderson.jpg" alt="" width="300" height="300">
        </div>
        <div class="col-md-4 col-sm-6">
          Aluno graduando do curso de Engenharia de Computação da Universidade Estadual de Feira de Santana (UEFS), Bahia, Brasil
        </div>
