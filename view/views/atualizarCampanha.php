...
$uploadfile = $uploaddir . basename($_FILES['campfile']['name']);




if (move_uploaded_file($_FILES['campfile']['tmp_name'], $uploadfile)) {
...
$codMaterial = CriadorFacade::getInstance()->buscarMetasCampanha($idCampanha);
var_dump($codMaterial);
